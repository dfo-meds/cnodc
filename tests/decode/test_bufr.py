...
class TestBufrParsing(ut.TestCase):
    ...
    def test_315004_1(self):
        ...
        self.assertEqual(r.metadata.best_value('ProfileID'), None)
        self.assertEqual(r.metadata.best_value('StationName'), None)
        self.assertEqual(r.metadata.best_value('ShipLineNumber'), None)
        self.assertEqual(r.metadata.best_value('SoftwareID'), None)
        ...
        self.assertEqual(levels[0].parameters['Temperature'].metadata.best_value('ProfilerSerialNumber'), None)
