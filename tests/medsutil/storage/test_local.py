...
class TestLocalHandle(BaseTestCase):
    ...
    def test_get_handle(self):
        ...
        self.assertIsInstance(sc.get_filepath(pathlib.Path(self.temp_dir)), LocalHandle)
        self.assertIsInstance(sc.get_filepath("C:/my/cnodc"), LocalHandle)
        self.assertIsInstance(sc.get_filepath("file://C:/my/cnodc"), LocalHandle)
        self.assertIsInstance(sc.get_filepath("/foo/bar"), LocalHandle)
