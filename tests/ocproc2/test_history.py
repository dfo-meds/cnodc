...
from cnodc.ocproc2 import HistoryEntry, MessageType, normalize_qc_path, QCMessage, QCTestRunInfo, QCResult
...
class TestQCMessage(ut.TestCase):
    ...
    def test_normalize_blank_qc_path(self):
        self.assertEqual('', normalize_qc_path(None))

    def test_normalize_qc_path(self):
        self.assertEqual('metadata/Property/metadata/Quality', normalize_qc_path('/metadata/Property//metadata/Quality/'))
