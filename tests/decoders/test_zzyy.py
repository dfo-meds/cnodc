...
class TestFM18XII(BaseTestCase):
    ...
    def test_decode(self):
        ...
        self.assert_element_equals(record.parameters, "WindDirection", "230", Units="degrees", Uncertainty=(5, {"UncertaintyType": "uniform"}), Quality=None, WMOWindSource="1", WMOAnemometerType="4", SensorHeight=(10, {"SensorHeightReference": "local_ground_corrected"}))
        self.assert_element_equals(record.parameters, "WindSpeed", "12", Units="m s-1", Uncertainty=(0.5, {"UncertaintyType": "uniform"}), Quality=None, WMOWindSource="1", WMOAnemometerType="4", SensorHeight=(10, {"SensorHeightReference": "local_ground_corrected"}))
