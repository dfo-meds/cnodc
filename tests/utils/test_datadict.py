...
from cnodc.util.awaretime import AwareDateTime, awaretime
...
class BoringObject(dd.DataDictObject):
    ...
    ddo_prop: t.Self = dd.p_json_object(t.Self)
    ddo_list_prop: list[t.Self] = dd.p_json_object_list(t.Self)
    ddo_dict_prop: dict[str, t.Self] = dd.p_json_object_dict(t.Self)
