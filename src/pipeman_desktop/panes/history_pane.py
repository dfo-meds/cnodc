...
class HistoryPane(BasePane):
    ...
    def on_init(self):
        history_frame = ttk.Frame(self.app.batch_bottom)
        ...
        self.app.batch_bottom.add(history_frame, text=i18n.tr("pane.history"), sticky='NSEW')
    ...
    def refresh_display(self, app_state: ApplicationState, change_type: DisplayChange):
        ...
        if change_type & DisplayChange.LANGUAGE:
            ...
            if self._pane_id is not None:
                self.app.batch_bottom.tab(self._pane_id, text=i18n.tr("pane.history"))
