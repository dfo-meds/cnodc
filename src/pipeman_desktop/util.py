...
class ApplicationState:
    ...
    def __init__(self, app: PipemanDesktop):
        ...
        self._batch_close_op: t.Optional[QCBatchCloseOperation] = None
    ...
    def can_close_current_batch(self, batch_action: QCBatchCloseOperation) -> bool:
        if self.save_in_progress:
            return False
        if self.batch_state is None or self.batch_state != BatchOpenState.OPEN:
            return False
