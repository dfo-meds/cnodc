...
class NODBObject(t.Protocol):
    ...
    @classmethod
    def find_all(cls, db: NODBInstance, **kwargs) -> t.Iterable[t.Self]: ...
...
class NODBInstance(t.Protocol):
    ...
    def fetch_next_queue_item(self, queue_name: str, app_id: str, subqueue_name: str | None = None, min_escalation: int = 0, max_escalation: int = 0, retries: int = 1) -> NODBQueueItem | None: ...
    ...
    def stream_temp_finalize_results(self, object_type: str, object_uuid: str) -> t.Iterable[tuple[str, str, str]]: ...
    def clear_temp_finalize_result(self, object_type: str, object_uuid: str): ...
