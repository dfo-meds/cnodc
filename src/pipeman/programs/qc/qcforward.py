...
from pipeman.processing.payloads import Payload, stream_payload_working_records, SourceFilePayload, BatchPayload, \
    WorkingRecordPayload
...
class QCForwardWorker(WorkflowWorker):
    ...
    def process_payload(self, payload: Payload) -> t.Optional[QueueItemResult]:
        if isinstance(payload, (SourceFilePayload, BatchPayload, WorkingRecordPayload)):
