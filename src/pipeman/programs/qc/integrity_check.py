...
from pipeman.programs.qc.base import DeepDiveChecker, SingleElementRef, review, RecordSetRef, ChildRecordRef, \
...
class NODBIntegrityChecker(DeepDiveChecker):
    ...
    @review("valid_data_type", fail_flag=-1, skip_empty=True)
    ...
    @review("compatible_units", fail_flag=-1, skip_empty=True)
    ...
    @review("valid_range", fail_flag=-1, skip_empty=True)
    ...
    @review("valid_recordset_type", fail_flag=-1)
    ...
    @review("valid_subrecord_coordinates", fail_flag=-1)
    ...
    @review("valid_element", fail_flag=-1)
    ...
    @review("multivalue_allowed", fail_flag=-1)
