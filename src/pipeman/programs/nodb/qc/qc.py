...
class BaseTestSuite:
    ...
    def calculate_pressure_in_dbar(self,
                                   ...
                                   latitude_val: t.Optional[ocproc2.SingleElement]) -> t.Optional[amath.AnyNumber]:
...
class QCTestRunner:
    ...
    def _check_skip_all(self, wr: NODBWorkingRecord, record: ocproc2.ParentRecord) -> t.Optional[tuple[
        ocproc2.QCResult, bool]]:
        return None
    ...
    def clear_db_instance(self, db: PostgresController):
        for test in self._qc_tests:
