...
from dmd.plugins.metadata_iso.util import preprocess_for_iso19115
...
NAP_CODE_LOOKUP = {
    ...
    'MD_RestrictionCode': {
        ...
        'values': {
            ...
            'licenceUnrestricted': ('RI_610', 'licenseUnrestricted'),
            'licenceEndUser': ('RI_611', 'licenseEndUser'),
            'licenceDistributor': ('RI_612', 'licenseDistributor'),
...
def preprocess_for_nap(**kwargs) -> dict[str, t.Any]:
    extras = preprocess_for_iso19115(**kwargs)
    extras["nap_code_map"] = nap_code_map
    extras["protocol_map"] = protocol_map
    return extras
