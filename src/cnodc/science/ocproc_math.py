...
import typing as t
import cnodc.science.seawater as seawater_sub
...
try:
    from cnodc.science import seawater
except ModuleNotFoundError:
    seawater = None
...
def density_at_depth(pressure: amath.AnyNumber,
    ...
    if gsw is not None and absolute_salinity is not None:
        ...
        # TODO: calculate uncertainty associated with this value
        density = seawater.dens(amath.to_float(practical_salinity), amath.to_float(temperature), amath.to_float(pressure))
...
def freezing_point(pressure: amath.AnyNumber,
    ...
    if gsw is not None and absolute_salinity is not None:
        ...
        # TODO: calculate uncertainty associated with this value
        fp = seawater.fp(amath.to_float(practical_salinity), amath.to_float(pressure))
    elif practical_salinity is not None:
...
def _convert_t68_to_t90(v):
    ...
    if gsw is not None:
        ...
        # TODO: calculate uncertainty associated with this value
        return seawater.library.T90conv(amath.to_float(v))
    else:
...
def depth_from_pressure(pressure: amath.AnyNumber,
    ...
    if gsw is not None:
        ...
        # TODO: calculate uncertainty associated with this value
        depth = seawater.dpth(amath.to_float(pressure), amath.to_float(latitude))
    else:
...
def pressure_from_depth(depth: amath.AnyNumber,
    ...
    # Secondary option is to use the EOS 80 model
        ...
        # TODO: calculate uncertainty associated with this value
        pressure = seawater.pres(amath.to_float(depth), amath.to_float(latitude))
