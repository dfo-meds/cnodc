...
class NODBObservation(_NODBBaseObject):
    ...
    obs_time: t.Optional[datetime.datetime] = DateTimeColumn("obs_time")
    min_depth: t.Optional[float] = FloatColumn("min_depth")
    max_depth: t.Optional[float] = FloatColumn("max_depth")
...
class GTSOutgoingMessage(_NODBBaseObject):
